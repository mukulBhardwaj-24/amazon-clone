const productsData = [
  {
    ...
    stock: 15,
    description: "A premium thin and light laptop with powerful performance for professionals and students.",
    points: [
    ...
    images: ["/images/products/1.jpg", "/images/products/1res.jpg"]
  },
  {
    ...
    category: "Mobiles",
    stock: 25,
    description: "A flagship smartphone with powerful camera and 5G connectivity.",
    points: [
    ...
    images: ["/images/products/2.jpg", "/images/products/2res.jpg"]
  },
  {
    ...
    images: ["/images/products/3.jpg", "/images/products/3res.jpg"]
  },
  {
    ...
    category: "Electronics",
    stock: 50,
    description: "Affordable wireless earbuds with excellent battery life.",
    points: [
    ...
    images: ["/images/products/4.jpg", "/images/products/4res.jpg"]
  },
  {
    ...
    stock: 20,
    description: "Premium quality mosquito net for a healthy sleeping environment.",
    points: [
    ...
    images: ["/images/products/5.jpg", "/images/products/5res.jpg"]
  },
  {
    ...
    images: ["/images/products/6.jpg", "/images/products/6res.jpg"]
  },
  {
    ...
    category: "Fashion",
    stock: 40,
    description: "Elegant ethnic wear set for women.",
    points: [
      "Care Instructions: Dry Clean Only",
      "Fit Type: Regular",
      "Print & Pattern : Solid ; Package Contant : Kurta, Palazzo With Dupatta"
    ],
    images: ["/images/products/7.jpg", "/images/products/7res.jpg"]
  },
  {
    ...
    category: "Electronics",
    stock: 18,
    description: "Smart security camera with 360-degree coverage.",
    points: [
    ...
    images: ["/images/products/8.jpg", "/images/products/8res.jpg"]
  },
  {
    ...
    category: "Fashion",
    stock: 22,
    description: "Classic analog watch for men with leather strap.",
    points: [
    ...
    images: ["/images/products/9.jpg", "/images/products/9res.jpg"]
  },
  {
    ...
    category: "Grocery",
    stock: 60,
    description: "Healthy breakfast cereal with nuts and dried fruits.",
    points: [
    ...
    images: ["/images/products/10.jpg", "/images/products/10res.jpg"]
  },
  {
    ...
    category: "Fashion",
    stock: 45,
    description: "Comfortable sweatshirt for men with modern fit.",
    points: [
    ...
    images: ["/images/products/11.jpg", "/images/products/11res.jpg"]
  },
  {
    ...
    category: "Fashion",
    stock: 28,
    description: "Stylish A-line dress for women.",
    points: [
    ...
    images: ["/images/products/12.jpg", "/images/products/12res.jpg"]
  },
  {
    ...
    category: "Electronics",
    stock: 32,
    description: "Powerful Bluetooth speaker with RGB lights and water resistance.",
    points: [
    ...
    images: ["/images/products/13.jpg", "/images/products/13res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 15,
    description: "Beautiful decorative candle holder for home décor.",
    points: [
    ...
    images: ["/images/products/14.jpg", "/images/products/14res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 12,
    description: "Elegant vintage flower vase for home decoration.",
    points: [
    ...
    images: ["/images/products/15.jpg", "/images/products/15res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 25,
    description: "Premium blackout curtains for windows.",
    points: [
    ...
    images: ["/images/products/16.jpg", "/images/products/16res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 40,
    description: "High-quality anti-skid doormat for homes.",
    points: [
    ...
    images: ["/images/products/17.jpg", "/images/products/17res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 30,
    description: "Beautiful embroidered cushion covers set.",
    points: [
    ...
    images: ["/images/products/18.jpg", "/images/products/18res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 18,
    description: "Complete bedding set with comforter and pillow covers.",
    points: [
    ...
    images: ["/images/products/19.jpg", "/images/products/19res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 22,
    description: "Decorative bird cage tealight holder.",
    points: [
    ...
    images: ["/images/products/20.jpg", "/images/products/20res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 14,
    description: "Handcrafted ceramic pot and vase.",
    points: [
      "This Diwali Light Your home with this beautiful Bird Cage Tealight Holder",
      "This stunning Kaameri Bazaar Tealight Holder makes for a perfect addition to your home.",
      "BENEFITS: They can accent your home or office for the right decor. Perfect for adding a decorative touch to any room's decor",
    ...
    images: ["/images/products/21.jpg", "/images/products/21res.jpg"]
  },
  {
    ...
    category: "Home & Kitchen",
    stock: 10,
    description: "Handcrafted wooden elephant garden table.",
    points: [
    ...
    images: ["/images/products/22.jpg", "/images/products/22res.jpg"]
  }
];
